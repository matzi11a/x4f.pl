...
class HaploConfig extends HaploSingleton {
    ...
    protected function __construct() {
        ...
        if (is_dir(HAPLO_CONFIG_PATH)) {
            ...
            if (!empty($this->environment)) {
                $this->parse_files(HAPLO_CONFIG_PATH, $this->environment['files']);
    ...
    protected function get_environments() {
        ...
        $hostname = SITE_BASE.'/hostname.txt';
        $server = file_exists($hostname) ? trim(file_get_contents($hostname)) : gethostname();
     ...
     * @throws HaploConfigKeyNotFoundException
     * @return string
     */
     ...
     * @throws HaploConfigSectionNotFoundException
     * @return string
     */
